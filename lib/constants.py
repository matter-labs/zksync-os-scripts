...
# Default gateway chain ID (script expects string)
...
CRS_FILE_URL = "https://storage.googleapis.com/matterlabs-setup-keys-europe/setup-keys/setup_2^24.key"

# SHA256 checksum for the trusted setup CRS file
CRS_FILE_SHA256_CHECKSUM = (
